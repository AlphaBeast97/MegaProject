...
export default function ImageToRecipePage() {
  ...
  if (!isLoaded) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 flex items-center justify-center pt-12 sm:pt-16">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 pt-12 sm:pt-16">
      {/* Background Elements */}
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-6xl relative z-0">
        <div className="mb-6 sm:mb-8">
          ...
          <div className="text-center mb-8 sm:mb-12 space-y-4">
            <div className="animate-fade-in-up">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-headline font-bold bg-gradient-to-r from-orange-600 via-red-500 to-pink-600 bg-clip-text text-transparent mb-4">
                Image to Recipe
              </h1>
              <div className="flex items-center justify-center space-x-2 mb-4 sm:mb-6">
                <Camera className="h-6 w-6 sm:h-8 sm:w-8 text-orange-500 animate-pulse" />
                <div className="w-6 sm:w-8 border-t-2 border-orange-300"></div>
                <Sparkles className="h-6 w-6 sm:h-8 sm:w-8 text-red-500 animate-pulse delay-500" />
                <div className="w-6 sm:w-8 border-t-2 border-red-300"></div>
                <ChefHat className="h-6 w-6 sm:h-8 sm:w-8 text-pink-500 animate-pulse delay-1000" />
              </div>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 bg-white/80 backdrop-blur-sm border-0 shadow-xl animate-fade-in-left">
            <CardHeader className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-t-lg p-4 sm:p-6">
              <CardTitle className="flex items-center text-lg sm:text-xl">
                <Camera className="mr-2 sm:mr-3 h-5 w-5 sm:h-6 sm:w-6 animate-pulse" />
                Upload Your Photo
              </CardTitle>
            ...
            <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6">
              <div className="border-2 border-dashed border-orange-200 rounded-xl p-6 sm:p-8 text-center hover:border-orange-400 transition-colors duration-300 bg-gradient-to-br from-orange-50 to-red-50">
                {imagePreview ? (
                  <div className="space-y-4 animate-fade-in">
                    <div className="relative w-full h-48 sm:h-56 md:h-64 mx-auto group">
                      <Image
                        src={imagePreview}
                        alt="Preview"
                        fill
                    ...
                    <Button
                      ...
                      className="hover:bg-orange-100 transition-colors duration-200 text-sm sm:text-base"
                    >
                  ...
                  <div className="space-y-4 animate-fade-in">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-orange-400 to-red-400 rounded-full flex items-center justify-center mx-auto mb-4 animate-bounce">
              ...
              {selectedImage && !generatedRecipe && (
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-3 sm:py-4 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 animate-fade-in-up text-sm sm:text-base"
                ...
                >
                  {isGenerating ? (
                    <>
                      ...
                      <span className="hidden sm:inline">Processing Magic...</span>
              ...
              {generatedRecipe ? (
                <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
                  ...
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-xl border border-orange-200">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-2 sm:mb-3 animate-fade-in">
                      {generatedRecipe.title}
                    </h3>
                    <p className="text-gray-600 text-base sm:text-lg leading-relaxed animate-fade-in delay-200 px-2">
                      {generatedRecipe.description}
                    </p>

                    {/* Recipe Stats */}
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-6 mt-3 sm:mt-4 animate-fade-in delay-400">
                      <div className="flex items-center space-x-2 bg-white/80 px-3 sm:px-4 py-2 rounded-full shadow-sm">
                        <Clock className="h-3 w-3 sm:h-4 sm:w-4 text-orange-500" />
                        <span className="text-xs sm:text-sm font-medium text-gray-700">30 min</span>
                      </div>
                      <div className="flex items-center space-x-2 bg-white/80 px-3 sm:px-4 py-2 rounded-full shadow-sm">
                        <Users className="h-3 w-3 sm:h-4 sm:w-4 text-red-500" />
                        <span className="text-xs sm:text-sm font-medium text-gray-700">4 servings</span>
                      </div>
                      <div className="flex items-center space-x-2 bg-white/80 px-3 sm:px-4 py-2 rounded-full shadow-sm">
                        <Star className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-500" />
                        <span className="text-xs sm:text-sm font-medium text-gray-700">Easy</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="animate-fade-in delay-600">
                    <div className="flex items-center mb-3 sm:mb-4">
                      <ChefHat className="h-5 w-5 sm:h-6 sm:w-6 text-orange-500 mr-2" />
                        ...
                        {generatedRecipe.ingredients.map(
                          (ingredient: string, index: number) => (
                            <li key={index} className="group flex items-center animate-slide-in-left" style={{ animationDelay: `${index * 100}ms` }}>
                              <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-r from-orange-400 to-red-400 rounded-full mr-3 sm:mr-4 flex-shrink-0 group-hover:scale-125 transition-transform duration-200"></div>
                  ...
                  <div className="animate-fade-in delay-800">
                    <div className="flex items-center mb-3 sm:mb-4">
                      <Sparkles className="h-5 w-5 sm:h-6 sm:w-6 text-red-500 mr-2" />
                        ...
                        (instruction: string, index: number) => (
                          <div key={index} className="group bg-white/80 backdrop-blur-sm rounded-xl p-3 sm:p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 animate-slide-in-right" style={{ animationDelay: `${index * 150}ms` }}>
                            <div className="flex items-start space-x-3 sm:space-x-4">
                              <div className="flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-red-400 to-pink-400 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold group-hover:scale-110 transition-transform duration-200">
                                {index + 1}
                              </div>
                  ...
                  <div className="text-center animate-fade-in delay-1000">
                    <Button
                      className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 text-sm sm:text-base"
                      size="lg"
                    >
                      <Star className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                      <span className="hidden sm:inline">Save This Recipe</span>
                ...
                <div className="text-center py-12 sm:py-16 space-y-3 sm:space-y-4">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 animate-pulse">
